                        ...
                        children: <Widget>[
                          RichText(
                            text: TextSpan(children: [
                              ...
                              TextSpan(
                                  text: "${user.userModel.cart[index].price }" +"DT"+"\n\n",
                                  style: TextStyle(
                                      color: black,
                                      fontSize: 18,
                ...
                text: TextSpan(children: [
                  TextSpan(
                      ...
                      style: TextStyle(
                          ...
                          fontWeight: FontWeight.w400)),
                  TextSpan(
                      text: " ${user.userModel.totalCartPrice }"+"DT",
                      style: TextStyle(
                          color: primary,
                          fontSize: 22,
                              ...
                              child: Container(
                                ...
                                child: Padding(
                                  ...
                                  child: Column(
                                    ...
                                    crossAxisAlignment: CrossAxisAlignment.start,
                                    children: [
                                      Text('You will be charged ${user.userModel.totalCartPrice }'+'DT upon delivery!', textAlign: TextAlign.center,),
